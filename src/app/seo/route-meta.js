...
export const ROUTE_META = {
  ...
  '/services': {
    ...
    keywords:
      'IT services, Odoo ERP, web development, mobile development, digital marketing, AI solutions',
    ogImage: DEFAULT_OG_IMAGE,
  },
  '/about': {
  ...
  '/careers': {
    ...
    keywords:
      'careers, jobs, hiring, software development jobs, UI/UX careers, odoo consultant',
    ogImage: DEFAULT_OG_IMAGE,
  },
  '/our-story': {
  ...
  '/process': {
    ...
    keywords:
      'development process, agile methodology, software development lifecycle, project management',
    ogImage: DEFAULT_OG_IMAGE,
  },
  '/blog': {
  ...
  '/visitor-management': {
    ...
    keywords:
      'visitor management, facility access, touchless check-in, QR code, meeting room booking',
    ogImage: DEFAULT_OG_IMAGE,
  },
  '/branding-services': {
  ...
  '/web-solutions': {
    ...
    keywords:
      'web development, custom web solutions, Next.js, headless CMS, performance optimization',
    ogImage: DEFAULT_OG_IMAGE,
  },
  '/mobile-development': {
    ...
    keywords:
      'mobile app development, iOS development, Android development, React Native, Flutter',
    ogImage: DEFAULT_OG_IMAGE,
  },
  '/odoo-erp': {
    ...
    keywords:
      'Odoo ERP, ERP implementation, Odoo customization, Odoo development, business management',
    ogImage: DEFAULT_OG_IMAGE,
  },
  '/product-development': {
  ...
  '/support-maintenance': {
    ...
    keywords:
      'technical support, maintenance services, 24/7 monitoring, bug fixes, performance optimization',
    ogImage: DEFAULT_OG_IMAGE,
  },
  '/younited-communities': {
    ...
    keywords:
      'community management, association management, member management, event coordination',
    ogImage: DEFAULT_OG_IMAGE,
  },
