      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 leading-relaxed">
            No commitment, no pressure, no pitch deck. Just an honest conversation about your business and where technology can genuinely help you move forward.
          </p>{' '}
          ...
          >
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm">No obligation, no sales pressure</span>
            </div>
            <div className="flex items-center space-x-2">
              {' '}
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
