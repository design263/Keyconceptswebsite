...
import { Sparkles, Palette, MessageSquare, FileText, Target, Lightbulb, Pen, Layers, ArrowRight, CheckCircle, Zap } from "lucide-react";
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              >
                ...
                <span className="text-sm font-semibold tracking-wider text-[#f1592a]">PREMIUM BRANDING</span>
              </motion.div>
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-light">
                We craft unforgettable brand identities that resonate with your audience 
                and stand the test of time. From concept to execution, we bring your vision to life.
              </p>
            </motion.div>
                      ...
                      >
                        {stage.style === "outline" ? (
                          ...
                          <svg width="120" height="120" viewBox="0 0 120 120" className="text-gray-400">
                            <circle cx="60" cy="60" r="40" fill="none" stroke="currentColor" strokeWidth="1.5" strokeDasharray="4 4" />
                            <path d="M 40 60 L 80 60 M 60 40 L 60 80" stroke="currentColor" strokeWidth="1.5" strokeDasharray="4 4" />
                          </svg>
                        ) : stage.style === "partial" ? (
                          // Refined Style
      ...
      <section className="py-24 bg-gradient-to-b from-gray-50 to-white relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-5xl mx-auto relative">
            ...
            >
              <div className="w-40 h-40 bg-white rounded-full shadow-2xl border-4 border-[#f1592a] flex items-center justify-center">
                <div className="text-center">
                  <Sparkles className="text-[#f1592a] mx-auto mb-2" size={32} strokeWidth={1.5} />
            ...
            {/* Ecosystem Nodes */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-16 pb-16" style={{ minHeight: '500px' }}>
              {ecosystemNodes.map((node, index) => (
                <motion.div
                  ...
                  className={`relative ${
                    node.position === 'top' ? 'md:col-span-3 md:mx-auto md:max-w-md' : ''
                  }`}
                  style={{
                ...
                >
                  <div className="group bg-white rounded-3xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all hover:-translate-y-2">
                    {/* Icon */}
                    <div className={`w-16 h-16 bg-gradient-to-br ${node.color} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
            ...
            {brandServices.map((service, index) => (
              ...
              >
                ...
                <div className="w-14 h-14 bg-gray-100 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#f1592a] transition-all">
                  <service.icon className="text-gray-700 group-hover:text-white transition-colors" size={24} strokeWidth={1.5} />
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <p className="text-xl text-gray-600 mb-8 leading-relaxed font-light">
                  Comprehensive documentation ensuring brand consistency across all touchpoints. 
                  A living system that scales with your business.
                </p>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-4 p-6 bg-gray-50">
                      {brandGuidelinePages.map((page, i) => (
                        ...
                        >
                          <div className={`${page.color} h-24 rounded-lg mb-3 group-hover:scale-105 transition-transform`} />
          ...
          >
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <p className="text-xl text-white/90 mb-8 font-light">
                ...
                with your audience. Book a discovery call today.
              </p>
