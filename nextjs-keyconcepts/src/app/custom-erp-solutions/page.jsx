        ...
        <section className="relative py-20 md:py-32 mt-5 bg-gradient-to-br from-gray-50 via-white to-gray-100 overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              >
                <motion.button
                  onClick={() => openModal('Custom ERP Solutions')}
                  whileHover={{
                    scale: 1.05,
                  }}
                  whileTap={{
                ...
                >
                  <span className="text-sm md:text-md font-semibold">Start a Conversation</span>
            ...
            >
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm md:text-md">Built for Your Business</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="w-4 h-4 md:w-5 md:h-5" />{' '}
                  <span className="text-sm md:text-md">Scales With Growth</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="w-4 h-4 md:w-5 md:h-5" />{' '}
