...
function NextArrow(props) {
  ...
  return /* @__PURE__ */ jsx("button", {
    onClick,
    className:
      "absolute -right-4 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-white/95 backdrop-blur-sm rounded-full shadow-xl border border-gray-200 flex items-center justify-center text-gray-700 hover:bg-[#f1592a] hover:text-white hover:border-[#f1592a] transition-all",
...
function PrevArrow(props) {
  ...
  return /* @__PURE__ */ jsx("button", {
    onClick,
    className:
      "absolute -left-4 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-white/95 backdrop-blur-sm rounded-full shadow-xl border border-gray-200 flex items-center justify-center text-gray-700 hover:bg-[#f1592a] hover:text-white hover:border-[#f1592a] transition-all",
    children: /* @__PURE__ */ jsx(ArrowRight, { size: 24, strokeWidth: 2 }),
  });
}
function CultureImageSlider() {
  const settings = {
    ...
    customPaging: () =>
      /* @__PURE__ */ jsx("button", {
        className:
          "w-2 h-2 rounded-full bg-gray-300 hover:bg-[#f1592a] transition-all",
      }),
  };
    ...
    children: [
      /* @__PURE__ */ jsx("div", {
        ...
        children: /* @__PURE__ */ jsx(Slider, {
          ...settings,
          children: cultureImages.map((image, index) =>
            /* @__PURE__ */ jsxs(
              "div",
              {
                className: "relative",
      ...
      /* @__PURE__ */ jsx(motion.div, {
        ...
        className:
          "absolute -bottom-6 -left-2 bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200 p-6",
        children: /* @__PURE__ */ jsxs("div", {
          className: "flex items-center space-x-4",
          children: [
            /* @__PURE__ */ jsx("div", {
              className:
                "w-12 h-12 bg-gradient-to-br from-[#f1592a] to-[#ff7a45] rounded-xl flex items-center justify-center",
      ...
      /* @__PURE__ */ jsx(motion.div, {
        ...
        className:
          "absolute -top-6 -right-2 bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200 p-6",
        children: /* @__PURE__ */ jsxs("div", {
          className: "flex items-center space-x-4",
          children: [
            /* @__PURE__ */ jsx("div", {
    ...
    children: [
          ...
          /* @__PURE__ */ jsx("div", {
            ...
            children: /* @__PURE__ */ jsxs("div", {
              ...
              children: [
                /* @__PURE__ */ jsxs(motion.div, {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx(motion.p, {
                      ...
                      children:
                        "Join a team of passionate builders, designers, and problem-solvers who are architecting the digital future. We're on a mission to transform businesses through innovative technology\u2014and we want you to be part of it.",
                    }),
                    /* @__PURE__ */ jsxs(motion.div, {
                      initial: { opacity: 0, y: 20 },
                      animate: { opacity: 1, y: 0 },
                ...
                /* @__PURE__ */ jsx("div", {
                  className: "relative",
                  children: /* @__PURE__ */ jsx(CultureImageSlider, {}),
                }),
              ],
            }),
          }),
            ...
            /* @__PURE__ */ jsxs(motion.div, {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("p", {
                  ...
                  children:
                    "We're building more than products\u2014we're building careers, relationships, and a culture that celebrates growth, innovation, and collaboration.",
                }),
              ],
            }),
            /* @__PURE__ */ jsx("div", {
              className: "grid md:grid-cols-2 lg:grid-cols-3 gap-8",
              children: whyWorkHere.map((benefit, index) =>
                /* @__PURE__ */ jsxs(
                  motion.div,
                  {
                    initial: { opacity: 0, y: 30 },
        ...
        children: /* @__PURE__ */ jsxs("div", {
          ...
          children: [
            /* @__PURE__ */ jsxs(motion.div, {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("p", {
                  className: "text-lg text-gray-600 max-w-3xl mx-auto",
                  children:
                    "These aren't just words on a wall\u2014they're the principles that guide how we work, collaborate, and deliver value every single day.",
                }),
              ],
            }),
            /* @__PURE__ */ jsx("div", {
                ...
                /* @__PURE__ */ jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx("div", {
                        className:
                          "flex-shrink-0 w-16 h-16 bg-gradient-to-br from-[#f1592a]/10 to-[#ff7a45]/10 rounded-2xl flex items-center justify-center border border-[#f1592a]/20",
            ...
            /* @__PURE__ */ jsx(motion.div, {
              ...
              viewport: { once: true },
              className:
                "bg-white rounded-3xl border border-gray-200 shadow-xl p-8 md:p-12",
              children: /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                              ...
                              /* @__PURE__ */ jsxs("div", {
                                children: [
                                  ...
                                  /* @__PURE__ */ jsx("p", {
                                    className: "text-gray-600",
                                    children:
                                      "Weekly tech talks, documentation culture, and cross-functional learning sessions.",
                                  }),
                                ],
                              }),
                            ],
                  ...
                  /* @__PURE__ */ jsxs("div", {
                    className:
                      "relative rounded-2xl overflow-hidden shadow-xl border border-gray-200",
                    children: [
                      /* @__PURE__ */ jsx(ImageWithFallback, {
        ...
        children: /* @__PURE__ */ jsxs("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("div", {
              ...
              children: perksAndBenefits.map((perk, index) =>
                /* @__PURE__ */ jsxs(
                  motion.div,
                  {
                    initial: { opacity: 0, y: 20 },
                    ...
                    className:
                      "flex items-center space-x-3 p-4 bg-gray-50 rounded-xl border border-gray-200 hover:border-[#f1592a]/30 transition-all",
                    children: [
                      /* @__PURE__ */ jsx("div", {
                        className:
                          "flex-shrink-0 w-10 h-10 bg-white rounded-lg flex items-center justify-center border border-gray-200",
                        children: /* @__PURE__ */ jsx(perk.icon, {
                          className: "text-[#f1592a]",
                          size: 20,
                          strokeWidth: 2,
                        }),
        ...
        children: /* @__PURE__ */ jsxs("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("div", {
              ...
              children: openRoles.map((role, index) =>
                /* @__PURE__ */ jsx(
                  motion.div,
                  {
                    initial: { opacity: 0, x: -30 },
                    ...
                    transition: { delay: index * 0.05 },
                    className:
                      "group bg-white rounded-2xl border border-gray-200 hover:border-[#f1592a]/30 hover:shadow-xl transition-all overflow-hidden",
                    children: /* @__PURE__ */ jsxs("div", {
                      className:
                        "p-6 md:p-8 flex flex-col md:flex-row md:items-center md:justify-between gap-6",
                      children: [
                        /* @__PURE__ */ jsx("div", {
                          ...
                          children: /* @__PURE__ */ jsxs("div", {
                            ...
                            children: [
                              /* @__PURE__ */ jsx("h3", {
                                className:
                                  "text-xl md:text-2xl font-bold text-gray-900 mb-2",
                                children: role.title,
                              }),
                              /* @__PURE__ */ jsxs("div", {
                                className:
                                  "flex flex-wrap gap-3 text-sm text-gray-600 mb-3",
                                children: [
                                  /* @__PURE__ */ jsxs("span", {
                                ...
                                children: [
                                  role.skills.slice(0, 4).map((skill) =>
                                    /* @__PURE__ */ jsx(
                                      ...
                                      {
                                        className:
                                          "px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-xs font-medium border border-gray-200",
                                        children: skill,
                                      },
                                      skill,
                                    ),
                                  ...
                                  role.skills.length > 4 &&
                                    /* @__PURE__ */ jsxs("span", {
                                      className:
                                        "px-3 py-1 text-gray-500 text-xs font-medium",
                                      children: [
                                        "+",
                                        role.skills.length - 4,
                                        " more",
                        ...
                        /* @__PURE__ */ jsxs("div", {
                          className:
                            "flex flex-col sm:flex-row md:flex-col gap-3 md:min-w-[140px]",
                          children: [
                            /* @__PURE__ */ jsx(Link, {
                              to: `/careers/${role.id}`,
                              children: /* @__PURE__ */ jsxs(motion.button, {
                                ...
                                whileTap: { scale: 0.97 },
                                className:
                                  "w-full flex items-center justify-center space-x-2 px-6 py-3 bg-white text-gray-700 border-2 border-gray-200 rounded-xl hover:border-[#f1592a] hover:text-[#f1592a] transition-all font-semibold shadow-sm hover:shadow-md",
                                children: [
                                  /* @__PURE__ */ jsx(Eye, {
                                    size: 18,
                                    strokeWidth: 2,
                            ...
                            /* @__PURE__ */ jsxs(motion.button, {
                              ...
                              className:
                                "w-full flex items-center justify-center space-x-2 px-6 py-3 bg-gradient-to-r from-[#f1592a] to-[#ff7a45] text-white rounded-xl shadow-lg hover:shadow-xl transition-all font-semibold",
                              children: [
            ...
            children: /* @__PURE__ */ jsxs(motion.div, {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("p", {
                  ...
                  children:
                    "Don't see a role that fits? Send us your resume anyway! We're always looking for talented people to join our growing team.",
                }),
                /* @__PURE__ */ jsxs("div", {
                  className:
                ...
                /* @__PURE__ */ jsxs(motion.div, {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("p", {
                      ...
                      children: "Or reach out to us directly:",
                    }),
                    /* @__PURE__ */ jsxs("div", {
                      className:
                        "flex flex-col sm:flex-row items-center justify-center gap-6 text-white",
                      children: [
                        /* @__PURE__ */ jsxs("a", {
                          href: "mailto:careers@keyconcepts.co.in",
                          className:
                            "flex items-center space-x-2 hover:text-[#f1592a] transition-colors",
                          children: [
                            /* @__PURE__ */ jsx(MapPin, { size: 18 }),
                            /* @__PURE__ */ jsx("span", {
                              children: "careers@keyconcepts.co.in",
                            }),
                          ],
                        }),
                        /* @__PURE__ */ jsx("span", {
      ...
      isModalOpen &&
        /* @__PURE__ */ jsx("div", {
          ...
          children: /* @__PURE__ */ jsxs("div", {
            className: "bg-white rounded-2xl shadow-2xl w-11/12 max-w-4xl p-8",
            children: [
              /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                  /* @__PURE__ */ jsxs("h2", {
                    className: "text-2xl font-bold text-gray-900",
                    children: ["Apply for ", selectedRole?.title],
                  }),
                  /* @__PURE__ */ jsx("button", {
                ...
                children: [
                      ...
                      /* @__PURE__ */ jsxs("div", {
                        children: [
                          ...
                          /* @__PURE__ */ jsx("input", {
                            type: "text",
                            className:
                              "mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#f1592a] focus:border-[#f1592a] sm:text-sm",
                          }),
                        ],
                      }),
                      /* @__PURE__ */ jsxs("div", {
                          ...
                          /* @__PURE__ */ jsxs("div", {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ jsxs("label", {
                                htmlFor: "resume",
                                className:
                                  "inline-flex items-center px-4 py-2 bg-gray-100 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#f1592a]",
                                children: [
                                  /* @__PURE__ */ jsx(Upload, {
                                    size: 16,
                                    className: "mr-2",
                  ...
                  /* @__PURE__ */ jsx("div", {
                    ...
                    children: /* @__PURE__ */ jsx("button", {
                      type: "submit",
                      className:
                        "w-full px-4 py-2 bg-gradient-to-r from-[#f1592a] to-[#ff7a45] text-white rounded-full shadow-2xl hover:shadow-[#f1592a]/50 transition-all font-semibold",
