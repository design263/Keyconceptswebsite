          ...
          <table className="w-full text-sm min-w-[760px]">
            <thead>
              <tr className="bg-muted/50 text-muted-foreground text-sm font-semibold border-b border-gray-200 uppercase tracking-wide">
                ...
                <th className="text-left px-5 py-2.5 font-semibold">Resume</th>
                ...
                applications.data.map((application) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3">
                      <button
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-sm text-xs font-semibold text-blue-600 bg-blue-50 hover:bg-blue-100 transition-colors"
                        onClick={() => openProtectedResume(application.resumeFilePath)}
                      >
                    ...
                    <td className="px-5 py-2">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          onClick={async () => {
                            try {
                              const res = await api.delete(`/applications/${application._id}`, token);
