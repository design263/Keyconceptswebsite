  ...
  return (
    <>
      <SEO
        ...
        description="Transform your reception with our touchless visitor management system. Features include instant host alerts, QR check-ins, meeting room booking, and parcel management."
      />
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="order-2 lg:order-1">
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  Smart booking system with real-time availability, automated scheduling, and resource
                  allocation for all meeting spaces.
                </p>{' '}
            ...
            >
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  Comprehensive event planning and coordination with attendee tracking, registration,
                  and access control for seamless events.
                </p>{' '}
                <ul className="space-y-4 mb-8">
                  {[
                    'Attendee registration',
            ...
            >
              ...
              <div className="order-2 lg:order-1">
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  Track and manage all incoming and outgoing parcels with automatic notifications and
            ...
            >
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  Optimize parking space utilization with smart allocation, automated gate control,
            ...
            >
              ...
              <div className="order-2 lg:order-1">
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  Streamline material movement with digital gate passes, approval workflows, and
