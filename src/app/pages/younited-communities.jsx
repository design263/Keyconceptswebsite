...
const heroStats = [
  { value: 1e4, suffix: "+", label: "Active Members", prefix: "", icon: Users, decimals: 0 },
          ...
          children: [
            /* @__PURE__ */ jsxs(
              motion.span,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-gray-700", children: "Community Management Platform" })
                ]
              }
            ),
            /* @__PURE__ */ jsxs(
              motion.h1,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("span", { className: "bg-gradient-to-r from-[#f1592a] to-[#ff7a45] bg-clip-text text-transparent", children: "Younited Communities" }),
                  /* @__PURE__ */ jsx("br", {}),
            ...
            /* @__PURE__ */ jsx(
              motion.p,
              {
                ...
                children: "A complete community and association management platform designed to streamline member management, event coordination, and approval workflows\u2014so you can focus on building stronger, more engaged communities."
              }
            ),
            /* @__PURE__ */ jsxs(
              motion.div,
      ...
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-600 max-w-3xl mx-auto", children: "Everything you need to manage your community efficiently, from member profiles to event coordination and approval workflows." })
          ]
        }
      ),
      /* @__PURE__ */ jsx(
      ...
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-5xl font-bold mb-4", children: [
              "Perfect For ",
              /* @__PURE__ */ jsx("span", { className: "bg-gradient-to-r from-[#f1592a] to-[#ff7a45] bg-clip-text text-transparent", children: "Every Community" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-600 max-w-3xl mx-auto", children: "Whether you're managing a Samaj, professional association, or non-profit organization\u2014Younited Communities adapts to your unique needs." })
          ]
        }
      ),
      /* @__PURE__ */ jsx("div", { className: "space-y-32", children: useCases.map((useCase, index) => /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: useCase.contentAlign === "right" ? "lg:col-start-2" : "", children: [
              /* @__PURE__ */ jsxs(
                motion.div,
                {
                  initial: { opacity: 0, x: -20 },
                  ...
                  children: [
                    /* @__PURE__ */ jsx(useCase.icon, { className: "text-[#f1592a]", size: 16 }),
                    /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-[#f1592a] uppercase tracking-wide", children: useCase.type })
                  ]
                }
              ),
              /* @__PURE__ */ jsx(
              ...
              /* @__PURE__ */ jsx(
                motion.div,
                {
                  ...
                  children: /* @__PURE__ */ jsxs("div", { className: "flex items-start space-x-4", children: [
                    /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 w-12 h-12 bg-white rounded-xl flex items-center justify-center border border-[#f1592a]/30 shadow-sm", children: /* @__PURE__ */ jsx(useCase.highlightedFeature.icon, { className: "text-[#f1592a]", size: 22, strokeWidth: 2 }) }),
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("h4", { className: "font-bold text-gray-900 mb-2", children: useCase.highlightedFeature.title }),
                      /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 leading-relaxed", children: useCase.highlightedFeature.description })
                    ] })
                  ] })
                }
              ),
              /* @__PURE__ */ jsx(
                motion.div,
                {
                  ...
                  children: useCase.features.map((feature, idx) => /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-3", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: useCase.contentAlign === "right" ? "lg:col-start-1 lg:row-start-1" : "", children: /* @__PURE__ */ jsxs(
              motion.div,
              {
      ...
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-600 max-w-3xl mx-auto", children: "Built for modern communities that demand efficiency, transparency, and scalability." })
          ]
        }
      ),
      /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-4 gap-8", children: keyBenefits.map((benefit, index) => /* @__PURE__ */ jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 30 },
          whileInView: { opacity: 1, y: 0 },
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "relative w-14 h-14 mb-6", children: [
              /* @__PURE__ */ jsx("div", { className: "w-full h-full bg-gray-100 rounded-xl flex items-center justify-center group-hover:bg-[#f1592a]/10 transition-all", children: /* @__PURE__ */ jsx(benefit.icon, { className: "text-gray-700 group-hover:text-[#f1592a] transition-colors", size: 28, strokeWidth: 1.5 }) }),
    ...
    /* @__PURE__ */ jsx("section", { className: "py-24 bg-white", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-600 max-w-3xl mx-auto", children: "A comprehensive toolkit designed to address every aspect of community management." })
          ]
        }
      ),
      /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-8", children: additionalCapabilities.map((capability, index) => /* @__PURE__ */ jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "flex items-start space-x-4", children: [
            /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 w-12 h-12 bg-white rounded-xl flex items-center justify-center border border-gray-200 group-hover:border-[#f1592a]/30 transition-all", children: /* @__PURE__ */ jsx(capability.icon, { className: "text-gray-700 group-hover:text-[#f1592a] transition-colors", size: 22, strokeWidth: 1.5 }) }),
            /* @__PURE__ */ jsxs("div", { children: [
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center space-x-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-8", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-white", children: "Ready to Transform Your Community?" })
            ] }),
            /* @__PURE__ */ jsxs("h2", { className: "text-3xl md:text-5xl font-bold text-white mb-6", children: [
              "Start Your ",
              /* @__PURE__ */ jsx("span", { className: "bg-gradient-to-r from-[#f1592a] to-[#ff7a45] bg-clip-text text-transparent", children: "Free Demo" }),
              " Today"
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-300 mb-10 leading-relaxed", children: "See how Younited Communities can streamline your operations, boost engagement, and help your community thrive. Schedule a personalized demo with our team." }),
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4", children: [
              /* @__PURE__ */ jsxs(
                motion.a,
                {
                  ...
                  className: "group px-8 py-4 bg-gradient-to-r from-[#f1592a] to-[#ff7a45] text-white rounded-full shadow-2xl hover:shadow-[#f1592a]/50 transition-all flex items-center justify-center space-x-2",
                  children: [
                    /* @__PURE__ */ jsx("span", { className: "font-semibold", children: "Schedule Demo" }),
                    /* @__PURE__ */ jsx(ArrowRight, { className: "group-hover:translate-x-1 transition-transform", size: 20 })
                  ]
                }
              ),
