...
export function OurStoryPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* New Generation Company with Legacy */}
              ...
              >
                <div className="relative w-12 h-12 mb-4">
                  <div className="w-full h-full bg-white rounded-xl flex items-center justify-center border border-gray-200 group-hover:border-[#f1592a]/30 transition-all shadow-sm">
                    <item.icon className="text-gray-700 group-hover:text-[#f1592a] transition-colors" size={24} strokeWidth={1.5} />
                  </div>
                ...
                <div className="inline-flex items-center space-x-2 px-3 py-1.5 bg-[#f1592a]/5 rounded-full border border-[#f1592a]/20">
                  ...
                  <span className="text-xs text-[#f1592a] font-semibold">
                    {item.benefit}
                  </span>
                </div>
              </motion.div>
            ...
            {whyClientsStay.map((reason, index) => (
              ...
              >
                <div className="relative w-12 h-12 mb-6">
                  <div className="w-full h-full bg-white rounded-xl flex items-center justify-center border border-gray-200 group-hover:border-[#f1592a]/30 transition-all shadow-sm">
                    <reason.icon className="text-gray-700 group-hover:text-[#f1592a] transition-colors" size={24} strokeWidth={1.5} />
                  </div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-gray-300 mb-10 max-w-2xl mx-auto leading-relaxed">
                Partner with a team that brings both modern agility and legacy reliability. 
