...
import { Shield, Zap, Bell, Scan, UserX, Clock, CheckCircle, Smartphone, Calendar, Users as UsersIcon, Package, Car, ClipboardCheck, DoorOpen, MapPin, Timer, TrendingUp, Leaf, UserCog } from "lucide-react";
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                Transform your reception area with a modern, touchless visitor management 
                system that prioritizes security without compromising user experience.
              </motion.p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything you need to manage visitors efficiently while maintaining 
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover a suite of integrated solutions designed to streamline your 
              operations and ensure the safety of your premises.
            </p>
          </motion.div>

          {/* Meeting Room Management - Left Content, Right Image */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <div className="order-2 lg:order-1">
              <div className="inline-flex items-center space-x-2 px-4 py-2 bg-[#f1592a]/10 backdrop-blur-sm rounded-full border border-[#f1592a]/20 mb-6">
                <DoorOpen className="text-[#f1592a]" size={18} strokeWidth={1.5} />
                <span className="text-sm font-semibold text-[#f1592a]">Smart Spaces</span>
              </div>
              ...
              <ul className="space-y-4 mb-8">
                {["Real-time room availability", "Calendar integration", "Automated check-in/out", "Capacity management"].map((feature, i) => (
            ...
            <div className="order-1 lg:order-2 relative">
              <div className="relative bg-gradient-to-br from-gray-100 to-gray-50 rounded-3xl p-8 border border-gray-200">
                <div className="bg-white rounded-2xl shadow-2xl p-8">
                  {/* Room booking interface mockup */}
                  <div className="flex items-center justify-between mb-6">
                    <h4 className="font-bold text-gray-900">Available Rooms</h4>
                    <div className="text-sm text-gray-500">Today, Feb 10</div>
                  </div>
          ...
          {/* Event Management - Right Content, Left Image */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <div className="relative">
              <div className="relative bg-gradient-to-br from-gray-100 to-gray-50 rounded-3xl p-8 border border-gray-200">
                <div className="bg-white rounded-2xl shadow-2xl p-8">
                  {/* Event dashboard mockup */}
                  <div className="flex items-center space-x-3 mb-6">
                    <div className="w-12 h-12 bg-gradient-to-br from-[#f1592a] to-[#ff7a45] rounded-xl flex items-center justify-center">
                      <Calendar className="text-white" size={24} strokeWidth={1.5} />
                    </div>
                    <div>
                      <h4 className="font-bold text-gray-900">Tech Summit 2026</h4>
                      <p className="text-sm text-gray-500">Feb 15 • 500 Attendees</p>
                    </div>
                  </div>
            ...
            <div>
              <div className="inline-flex items-center space-x-2 px-4 py-2 bg-[#f1592a]/10 backdrop-blur-sm rounded-full border border-[#f1592a]/20 mb-6">
                ...
                <span className="text-sm font-semibold text-[#f1592a]">Event Platform</span>
              </div>
              ...
              <ul className="space-y-4 mb-8">
                {["Attendee registration", "Batch invitations", "Access control", "Real-time analytics"].map((feature, i) => (
                  <li key={i} className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-[#f1592a]/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                      <CheckCircle className="text-[#f1592a]" size={14} strokeWidth={2.5} />
                    </div>
          ...
          {/* Parcel Management - Left Content, Right Image */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <div className="order-2 lg:order-1">
              <div className="inline-flex items-center space-x-2 px-4 py-2 bg-[#f1592a]/10 backdrop-blur-sm rounded-full border border-[#f1592a]/20 mb-6">
                <Package className="text-[#f1592a]" size={18} strokeWidth={1.5} />
                <span className="text-sm font-semibold text-[#f1592a]">Delivery Tracking</span>
              </div>
              ...
              <ul className="space-y-4 mb-8">
                {["Parcel tracking", "Delivery notifications", "Photo verification", "Digital signatures"].map((feature, i) => (
                  <li key={i} className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-[#f1592a]/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                      <CheckCircle className="text-[#f1592a]" size={14} strokeWidth={2.5} />
                    </div>
            ...
            <div className="order-1 lg:order-2 relative">
              <div className="relative bg-gradient-to-br from-gray-100 to-gray-50 rounded-3xl p-8 border border-gray-200">
                <div className="bg-white rounded-2xl shadow-2xl p-8">
                  ...
                  <div className="mb-6">
                    <h4 className="font-bold text-gray-900 mb-4">Today's Deliveries</h4>
          ...
          {/* Parking Management - Right Content, Left Image */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
                      ...
                      {Array.from({ length: 20 }).map((_, i) => (
                        <div
                          ...
                          className={`aspect-square rounded-lg flex items-center justify-center border ${
                            i % 3 === 0 ? "bg-gray-200 border-gray-300" : "bg-[#f1592a]/10 border-[#f1592a]/20"
                          }`}
                        >
                          <Car 
            ...
            <div>
              <div className="inline-flex items-center space-x-2 px-4 py-2 bg-[#f1592a]/10 backdrop-blur-sm rounded-full border border-[#f1592a]/20 mb-6">
                <Car className="text-[#f1592a]" size={18} strokeWidth={1.5} />
                <span className="text-sm font-semibold text-[#f1592a]">Smart Parking</span>
              </div>
              ...
              <ul className="space-y-4 mb-8">
                {["Slot allocation", "License plate recognition", "Automated gates", "Violation alerts"].map((feature, i) => (
                  <li key={i} className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-[#f1592a]/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                      <CheckCircle className="text-[#f1592a]" size={14} strokeWidth={2.5} />
                    </div>
          ...
          {/* Material Gate Pass - Left Content, Right Image */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <div className="order-2 lg:order-1">
              <div className="inline-flex items-center space-x-2 px-4 py-2 bg-[#f1592a]/10 backdrop-blur-sm rounded-full border border-[#f1592a]/20 mb-6">
                <ClipboardCheck className="text-[#f1592a]" size={18} strokeWidth={1.5} />
                <span className="text-sm font-semibold text-[#f1592a]">Material Control</span>
              </div>
              ...
              <ul className="space-y-4 mb-8">
                {["Digital gate passes", "Approval workflows", "Material tracking", "Compliance reporting"].map((feature, i) => (
                  <li key={i} className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-[#f1592a]/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                      <CheckCircle className="text-[#f1592a]" size={14} strokeWidth={2.5} />
                    </div>
            ...
            <div className="order-1 lg:order-2 relative">
              <div className="relative bg-gradient-to-br from-gray-100 to-gray-50 rounded-3xl p-8 border border-gray-200">
                <div className="bg-white rounded-2xl shadow-2xl p-8">
                  {/* Gate pass interface */}
                  <div>
                    <h4 className="font-bold text-gray-900 mb-4">Active Gate Passes</h4>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Join hundreds of companies that trust our visitor management system 
                for safety, speed, and seamless operations.
              </p>
