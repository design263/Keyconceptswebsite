...
// Hero Stats Data
const heroStats = [
  { value: 500000, suffix: "+", label: "Voters Reached", prefix: "", icon: Users, decimals: 0 },
...
export function ElectionMobilizationPage() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              A centralized platform designed to manage digital campaigning, engage voters effectively, 
              and track outreach performance in real time.
            </motion.p>
      ...
      <section className="py-24 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-4">
              Why It <span className="bg-gradient-to-r from-[#f1592a] to-[#ff7a45] bg-clip-text text-transparent">Matters</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              ...
              >
                <div className="relative w-14 h-14 mb-6">
                  <div className="w-full h-full bg-gray-100 rounded-xl flex items-center justify-center group-hover:bg-[#f1592a]/10 transition-all">
                    <item.icon className="text-gray-700 group-hover:text-[#f1592a] transition-colors" size={28} strokeWidth={1.5} />
                  </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-4">
              Built For <span className="bg-gradient-to-r from-[#f1592a] to-[#ff7a45] bg-clip-text text-transparent">Every Campaign</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            ...
            {campaignTypes.map((campaign, index) => (
              <motion.div
                ...
                className={`grid lg:grid-cols-2 gap-12 lg:gap-16 items-center ${
                  campaign.contentAlign === "right" ? "lg:grid-flow-dense" : ""
                }`}
              >
                {/* Content Side */}
                  ...
                  >
                    <div className="flex items-start space-x-4">
                      <div className="flex-shrink-0 w-12 h-12 bg-white rounded-xl flex items-center justify-center border border-[#f1592a]/30 shadow-sm">
                        <campaign.highlightedFeature.icon className="text-[#f1592a]" size={22} strokeWidth={2} />
                      </div>
                      <div>
                ...
                {/* Image Side */}
                <div className={campaign.contentAlign === "right" ? "lg:col-start-1 lg:row-start-1" : ""}>
                  <motion.div
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
              Mobilize. Engage. <span className="bg-gradient-to-r from-[#f1592a] to-[#ff7a45] bg-clip-text text-transparent">Win.</span>
            </h2>
