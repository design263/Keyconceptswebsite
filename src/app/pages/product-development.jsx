...
function ProductDevelopmentPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white", children: [
            ...
            /* @__PURE__ */ jsxs(
              motion.span,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-gray-700", children: "Custom Product Development" })
                ]
              }
            ),
            /* @__PURE__ */ jsxs(
              motion.h1,
              {
                ...
                children: [
                  "Build Products That",
                  " ",
                  /* @__PURE__ */ jsx("span", { className: "bg-gradient-to-r from-[#f1592a] to-[#ff7a45] bg-clip-text text-transparent", children: "Users Love" })
                ]
              }
            ),
            /* @__PURE__ */ jsx(
              motion.p,
              {
                ...
                children: "From concept to launch, we craft scalable web & mobile applications with modern tech stacks, agile methodology, and a relentless focus on user experience."
              }
            ),
            /* @__PURE__ */ jsxs(
              motion.div,
                ...
                children: [
                  /* @__PURE__ */ jsxs(
                    motion.a,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsx("span", { className: "font-semibold", children: "Talk to Product Team" }),
    ...
    /* @__PURE__ */ jsx("section", { id: "who-its-for", className: "py-24 bg-white", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 30 },
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("h2", { className: "text-4xl md:text-5xl font-bold mb-4", children: "Built for Ambitious Teams" }),
            /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-600 max-w-3xl mx-auto", children: "Whether you're launching a startup or scaling an enterprise, we're your technical partner" })
          ]
        }
      ),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6", children: targetAudience.map((audience, index) => /* @__PURE__ */ jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "relative bg-white/60 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-white/60 hover:bg-white hover:border-[#f1592a] hover:shadow-2xl transition-all duration-300 h-full text-center", children: [
            /* @__PURE__ */ jsxs("div", { className: "relative w-14 h-14 mb-4 mx-auto group-hover:scale-110 transition-transform", children: [
              /* @__PURE__ */ jsx("div", { className: "w-full h-full bg-gray-100 rounded-xl flex items-center justify-center group-hover:bg-white transition-all", children: /* @__PURE__ */ jsx(audience.icon, { className: "text-gray-700", size: 28, strokeWidth: 1.5 }) }),
              /* @__PURE__ */ jsx("div", { className: "absolute -bottom-1 -right-1 w-3 h-3 bg-[#f1592a] rounded-full border-2 border-white" })
            ] }),
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold mb-2", children: audience.title }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-600 text-sm leading-relaxed", children: audience.description })
          ] })
        },
        audience.title
      )) })
    ...
    /* @__PURE__ */ jsx("section", { className: "py-24 bg-gradient-to-b from-white to-gray-50", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("h2", { className: "text-4xl md:text-5xl font-bold mb-4", children: "Full-Stack Product Development" }),
            /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-600 max-w-3xl mx-auto mb-12", children: "From frontend to backend, mobile to AI \u2014 we build complete, production-ready products" }),
            /* @__PURE__ */ jsx("div", { className: "flex flex-wrap items-center justify-center gap-3", children: buildCategories.map((category, index) => /* @__PURE__ */ jsx(
              motion.button,
              {
                initial: { opacity: 0, y: 20 },
                whileInView: { opacity: 1, y: 0 },
      ...
      selectedCategory && /* @__PURE__ */ jsx(
        motion.div,
        {
          ...
          children: buildCategories.filter((cat) => cat.id === selectedCategory).map((category) => /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsxs("div", { className: "relative w-14 h-14 mb-6", children: [
                    /* @__PURE__ */ jsx("div", { className: "w-full h-full bg-white rounded-2xl flex items-center justify-center shadow-lg border border-gray-200", children: /* @__PURE__ */ jsx(category.icon, { className: "text-gray-700", size: 28, strokeWidth: 1.5 }) }),
                    /* @__PURE__ */ jsx("div", { className: "absolute -bottom-1 -right-1 w-4 h-4 bg-[#f1592a] rounded-full border-2 border-white" })
                  ] }),
                  /* @__PURE__ */ jsx("h3", { className: "text-3xl md:text-4xl font-bold mb-4", children: category.title }),
                  /* @__PURE__ */ jsx("p", { className: "text-gray-600 text-lg mb-8 leading-relaxed", children: category.longDescription }),
                  /* @__PURE__ */ jsx("ul", { className: "space-y-3 mb-8", children: category.features.map((feature, idx) => /* @__PURE__ */ jsxs("li", { className: "flex items-start space-x-3", children: [
                    /* @__PURE__ */ jsx(
                      CheckCircle,
                      {
                  ...
                  /* @__PURE__ */ jsxs(
                    motion.a,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsx("span", { children: "Start Building" }),
      ...
      !selectedCategory && /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsx("p", { className: "text-gray-500 text-lg mb-6", children: "Select a category to learn more" }),
            /* @__PURE__ */ jsx(
              motion.button,
              {
                whileHover: { scale: 1.05 },
    ...
    /* @__PURE__ */ jsxs("section", { className: "py-24 bg-white relative overflow-hidden", children: [
      /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 opacity-20", children: [
        /* @__PURE__ */ jsx("div", { className: "absolute top-10 right-10 w-96 h-96 bg-[#f1592a]/10 rounded-full blur-3xl" }),
        /* @__PURE__ */ jsx("div", { className: "absolute bottom-10 left-10 w-96 h-96 bg-gray-300/20 rounded-full blur-3xl" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: [
        /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("h2", { className: "text-4xl md:text-5xl font-bold mb-4", children: "Agile, Transparent, Iterative" }),
              /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-600 max-w-3xl mx-auto", children: "Our proven delivery methodology ensures quality, speed, and continuous feedback" })
            ]
          }
        ),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8", children: deliverySteps.map((step, index) => /* @__PURE__ */ jsxs(
          motion.div,
          {
            initial: { opacity: 0, y: 50 },
            whileInView: { opacity: 1, y: 0 },
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "relative bg-white/60 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-white/60 hover:bg-white hover:border-[#f1592a] hover:shadow-2xl transition-all duration-300 h-full", children: [
                /* @__PURE__ */ jsx("div", { className: "text-5xl font-bold text-[#f1592a]/20 mb-4", children: step.number }),
                /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold mb-3", children: step.title }),
                /* @__PURE__ */ jsx("p", { className: "text-gray-600 text-sm leading-relaxed", children: step.description })
              ] }),
              index < deliverySteps.length - 1 && /* @__PURE__ */ jsx("div", { className: "hidden lg:block absolute top-1/2 -right-4 transform -translate-y-1/2 z-20", children: /* @__PURE__ */ jsx(ArrowRight, { className: "text-[#f1592a]/30", size: 24 }) })
            ]
          },
          step.number
        )) }),
        /* @__PURE__ */ jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "relative rounded-3xl overflow-hidden shadow-2xl", children: [
              /* @__PURE__ */ jsx(
                ImageWithFallback,
                {
      ...
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("h2", { className: "text-4xl md:text-5xl font-bold mb-4", children: "Flexible Engagement Options" }),
            /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-600 max-w-3xl mx-auto", children: "Choose the model that fits your project stage, budget, and timeline" })
          ]
        }
      ),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto", children: engagementModels.map((model, index) => /* @__PURE__ */ jsx(
        motion.div,
        {
          initial: { opacity: 0, y: 50 },
          whileInView: { opacity: 1, y: 0 },
          ...
          whileHover: { y: -10 },
          className: "group",
          children: /* @__PURE__ */ jsxs("div", { className: "relative bg-white/60 backdrop-blur-lg rounded-3xl p-8 shadow-lg border border-white/60 hover:bg-white hover:border-[#f1592a] hover:shadow-2xl transition-all duration-300 h-full", children: [
            /* @__PURE__ */ jsx("div", { className: "absolute top-6 right-6", children: /* @__PURE__ */ jsx("span", { className: "px-3 py-1 bg-[#f1592a]/10 text-[#f1592a] text-xs font-semibold rounded-full", children: model.highlight }) }),
            /* @__PURE__ */ jsxs("div", { className: "relative w-16 h-16 mb-6 group-hover:scale-110 transition-transform", children: [
              /* @__PURE__ */ jsx("div", { className: "w-full h-full bg-gray-100 rounded-2xl flex items-center justify-center group-hover:bg-white transition-all", children: /* @__PURE__ */ jsx(model.icon, { className: "text-gray-700", size: 32, strokeWidth: 1.5 }) }),
              /* @__PURE__ */ jsx("div", { className: "absolute -bottom-1 -right-1 w-4 h-4 bg-[#f1592a] rounded-full border-2 border-white" })
            ] }),
            /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold mb-4", children: model.title }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-600 mb-6 leading-relaxed", children: model.description }),
            /* @__PURE__ */ jsx("ul", { className: "space-y-3", children: model.features.map((feature, idx) => /* @__PURE__ */ jsxs("li", { className: "flex items-start space-x-3", children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "py-24 bg-white relative overflow-hidden", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 opacity-20", children: /* @__PURE__ */ jsx("div", { className: "absolute top-10 left-10 w-96 h-96 bg-[#f1592a]/10 rounded-full blur-3xl" }) }),
      /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: [
        /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("h2", { className: "text-4xl md:text-5xl font-bold mb-4", children: "Modern, Battle-Tested Technologies" }),
              /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-600 max-w-3xl mx-auto", children: "We use proven frameworks and tools that scale with your business" })
            ]
          }
        ),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 max-w-6xl mx-auto", children: Object.entries(techStack).map(([category, technologies], index) => /* @__PURE__ */ jsx(
          motion.div,
          {
            initial: { opacity: 0, y: 50 },
            whileInView: { opacity: 1, y: 0 },
            ...
            transition: { delay: index * 0.1 },
            className: "group",
            children: /* @__PURE__ */ jsxs("div", { className: "relative bg-white/60 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-white/60 hover:bg-white hover:border-[#f1592a] hover:shadow-2xl transition-all duration-300 h-full", children: [
              /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold mb-4 capitalize text-center", children: category }),
              /* @__PURE__ */ jsx("ul", { className: "space-y-2", children: technologies.map((tech) => /* @__PURE__ */ jsx("li", { className: "text-center", children: /* @__PURE__ */ jsx("span", { className: "inline-block px-3 py-1 bg-gray-100 text-gray-700 text-sm rounded-lg group-hover:bg-[#f1592a]/10 group-hover:text-[#f1592a] transition-all", children: tech }) }, tech)) })
            ] })
          },
          category
        )) }),
      ...
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-600 leading-relaxed", children: "16+ years of experience building products that scale, backed by a team that cares" })
          ]
        }
      ),
            ...
            /* @__PURE__ */ jsxs(
              motion.span,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "text-white font-medium", children: "Ready to Build?" })
                ]
              }
            ),
            /* @__PURE__ */ jsx("h2", { className: "text-4xl md:text-5xl font-bold mb-6", children: "Let's Turn Your Idea into Reality" }),
            /* @__PURE__ */ jsx("p", { className: "text-xl text-white/90 mb-10 leading-relaxed", children: "Schedule a free consultation with our product team. We'll discuss your vision, tech requirements, timeline, and provide a custom proposal." }),
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4", children: [
              /* @__PURE__ */ jsxs(
                motion.a,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("span", { children: "Talk to Product Team" }),
                    /* @__PURE__ */ jsx(ArrowRight, { className: "group-hover:translate-x-1 transition-transform", size: 20 })
                  ]
                }
              ),
