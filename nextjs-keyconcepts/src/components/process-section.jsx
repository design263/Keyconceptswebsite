      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            A proven methodology that transforms your vision into reality through six strategic
            phases
          </p>
        </motion.div>{' '}
            ...
            {processSteps.map((step, index) => (
              ...
              >
                ...
                <div className="group relative bg-white/60 backdrop-blur-lg rounded-2xl p-8 shadow-lg border border-white/60 hover:bg-white hover:border-[#f1592a] hover:shadow-2xl transition-all duration-300">
                  ...
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${step.color} opacity-0 group-hover:opacity-5 transition-opacity rounded-2xl pointer-events-none`}
                  />
