...
// Main Support Services with Tab Content
...
export function SupportMaintenancePage() {
  const [selectedService, setSelectedService] = useState<string | null>("monitoring");
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {slaTiers.map((tier, index) => (
              ...
              >
                ...
                <div className={`relative h-full bg-white/60 backdrop-blur-lg rounded-3xl p-8 shadow-lg border ${
                  tier.highlight 
                    ? "border-[#f1592a] shadow-2xl scale-105" 
                    : "border-white/60 hover:border-[#f1592a] hover:shadow-2xl"
                  ...
                  <motion.a
                    ...
                    className={`block w-full text-center px-6 py-3 rounded-full font-semibold transition-all ${
                      tier.highlight
                        ? "bg-gradient-to-r from-[#f1592a] to-[#ff7a45] text-white shadow-lg"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              ...
              <div className="flex items-center space-x-2">
                <CheckCircle size={20} />
                <span>Flexible SLA options</span>
              </div>
              <div className="flex items-center space-x-2">
                <CheckCircle size={20} />
                <span>24/7 monitoring included</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
