  ...
  return (
    <>
      <SEO
        ...
        description="Expert mobile app development services for iOS and Android. We build high-performance, secure, and user-friendly mobile applications using native and cross-platform technologies."
      />
