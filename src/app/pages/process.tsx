...
export function ProcessPage() {
  return (
    <div className="min-h-screen bg-white">
              ...
              return (
                ...
                >
                  <div className={`grid lg:grid-cols-2 gap-8 lg:gap-16 items-center ${isEven ? '' : 'lg:grid-flow-dense'}`}>
                    {/* Text Content */}
                    <div className={`${isEven ? 'lg:text-right' : 'lg:col-start-2 lg:text-left'} lg:pr-8`}>
                      <motion.div
                      ...
                      >
                        <div className={`inline-flex items-center space-x-2 mb-4 ${isEven ? 'lg:flex-row-reverse lg:space-x-reverse' : ''}`}>
                        ...
                        <div className="space-y-2">
                          {step.deliverables.map((deliverable, i) => (
                            <div key={i} className={`flex items-center space-x-2 ${isEven ? 'lg:flex-row-reverse lg:space-x-reverse' : ''}`}>
      ...
      {/* Transparent Communication & Release Excellence - Combined Section */}
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1536px]">
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              >
                <div className="relative flex-shrink-0">
                  <div className="w-14 h-14 bg-white border-2 border-gray-200 rounded-xl flex items-center justify-center group-hover:border-[#f1592a]/30 transition-all shadow-sm">
                    <Rocket className="text-gray-700 group-hover:text-[#f1592a] transition-colors" size={24} strokeWidth={1.5} />
                  </div>
              ...
              >
                <div className="relative flex-shrink-0">
                  <div className="w-14 h-14 bg-white border-2 border-gray-200 rounded-xl flex items-center justify-center group-hover:border-[#f1592a]/30 transition-all shadow-sm">
                    <Users className="text-gray-700 group-hover:text-[#f1592a] transition-colors" size={24} strokeWidth={1.5} />
                  </div>
                  <div className="absolute -bottom-1 -right-1 w-3 h-3 bg-[#f1592a] rounded-full border-2 border-white" />
                </div>
                <div className="flex-1">
              ...
              >
                <div className="relative flex-shrink-0">
                  <div className="w-14 h-14 bg-white border-2 border-gray-200 rounded-xl flex items-center justify-center group-hover:border-[#f1592a]/30 transition-all shadow-sm">
                    <Award className="text-gray-700 group-hover:text-[#f1592a] transition-colors" size={24} strokeWidth={1.5} />
                  </div>
                  <div className="absolute -bottom-1 -right-1 w-3 h-3 bg-[#f1592a] rounded-full border-2 border-white" />
                </div>
                <div className="flex-1">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center group-hover:bg-[#f1592a]/10 transition-all">
                      <Eye className="text-gray-700 group-hover:text-[#f1592a] transition-colors" size={20} />
                    </div>
          ...
          {/* Communication Schedule Bottom Section */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-gray-300">Regular touchpoints and automated deployments for maximum transparency</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {['Code Commit', 'Auto Tests', 'Staging Deploy', 'Client Review', 'Production'].map((stage, i) => (
                    <div key={stage} className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-6 hover:border-[#f1592a]/30 hover:shadow-lg transition-all duration-300 text-center h-full flex flex-col items-center justify-center">
                  <div className="relative mb-3">
                    <div className="w-14 h-14 bg-gray-100 rounded-xl flex items-center justify-center group-hover:bg-[#f1592a]/5 transition-all mx-auto">
                      <tool.icon className="text-gray-700 group-hover:text-[#f1592a] transition-colors" size={28} strokeWidth={1.5} />
                    </div>
                    <div className="absolute -bottom-1 -right-1 w-3 h-3 bg-[#f1592a] rounded-full border-2 border-white" />
                  </div>
          ...
          >
            <div className="inline-block bg-white border border-gray-200 rounded-2xl p-6">
              <p className="text-gray-600 mb-2">
                <span className="font-semibold text-gray-900">Plus:</span> Tailored tool stack based on your team's preferences
              </p>
              <p className="text-sm text-gray-500">
                We adapt to your existing workflows and tools
              </p>
            </div>
          </motion.div>
        </div>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6 h-full hover:border-[#f1592a]/30 hover:bg-white hover:shadow-lg transition-all duration-300">
                  <div className="relative w-14 h-14 mb-4">
                    <div className="w-full h-full bg-white rounded-lg flex items-center justify-center group-hover:bg-[#f1592a]/5 transition-all border border-gray-200">
                      <qa.icon className="text-gray-700 group-hover:text-[#f1592a] transition-colors" size={24} strokeWidth={1.5} />
                    </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1536px]">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {supportTiers.map((tier, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className={`relative bg-white border-2 rounded-3xl p-8 h-full ${
                  index === 0 
                    ? 'border-[#f1592a] shadow-xl shadow-[#f1592a]/10' 
          ...
          >
            ...
            <p className="text-lg text-white/90 max-w-3xl mx-auto mb-6">
              Every project includes a 30-day critical support period with unlimited bug fixes and optimizations. 
              We're committed to your success, not just your launch.
            </p>
          ...
          >
            ...
            <div className="relative z-10">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Ready to Experience
                <br />
                <span className="text-[#f1592a]">Our Process?</span>
              </h2>
