...
const blogPosts = [
  {
    ...
    excerpt:
      'Discover how artificial intelligence is revolutionizing enterprise resource planning and what it means for your business.',
    author: 'Sarah Johnson',
    date: 'February 8, 2026',
    category: 'AI & Automation',
    image:
      'https://images.unsplash.com/photo-1770233621425-5d9ee7a0a700?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhcnRpZmljaWFsJTIwaW50ZWxsaWdlbmNlJTIwZGlnaXRhbCUyMGJyYWlufGVufDF8fHx8MTc3MDcwMjUwMnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    featured: true,
  },
  {
    title: 'Why Cloud-Native Architecture is Essential for Modern Businesses',
    excerpt:
      'Learn about the benefits of cloud-native development and how it can transform your application infrastructure.',
    author: 'Michael Chen',
    date: 'February 5, 2026',
    category: 'Cloud Computing',
    image:
      'https://images.unsplash.com/photo-1744868562210-fffb7fa882d9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjbG91ZCUyMGNvbXB1dGluZyUyMGRhdGElMjBjZW50ZXJ8ZW58MXx8fHwxNzcwNjM3OTYwfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    featured: false,
  },
  {
    title: 'Building a Digital Immune System: Complete Security Guide',
    excerpt:
      'A comprehensive guide to protecting your digital infrastructure from modern cyber threats.',
    author: 'David Thompson',
    date: 'February 2, 2026',
    category: 'Cybersecurity',
    image:
      'https://images.unsplash.com/photo-1762340916350-ad5a3d620c16?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjeWJlcnNlY3VyaXR5JTIwbmV0d29yayUyMHByb3RlY3Rpb258ZW58MXx8fHwxNzcwNjQyODA1fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    featured: false,
  },
  {
    title: 'Odoo 18: New Features and Implementation Best Practices',
    excerpt:
      'Everything you need to know about the latest Odoo release and how to implement it effectively.',
    author: 'Emily Rodriguez',
    date: 'January 30, 2026',
    category: 'ERP Solutions',
    image:
      'https://images.unsplash.com/photo-1662027067763-770376e710f5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlcnAlMjBlbnRlcnByaXNlJTIwc29mdHdhcmV8ZW58MXx8fHwxNzcwNzAyNTQ3fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    featured: false,
  },
  {
    title: 'Mobile-First Development: Why It Matters in 2026',
    excerpt:
      'Understanding the importance of mobile-first approach in modern web and app development.',
    author: 'John Anderson',
    date: 'January 28, 2026',
    category: 'Mobile Development',
    image:
      'https://images.unsplash.com/photo-1633250391894-397930e3f5f2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2JpbGUlMjBhcHAlMjBkZXZlbG9wbWVudHxlbnwxfHx8fDE3NzA1ODQ0MjR8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    featured: false,
  },
  {
    title: 'SEO Trends and Strategies for 2026: Complete Guide',
    excerpt:
      'Stay ahead of the competition with the latest SEO trends and proven optimization strategies.',
    author: 'Sarah Johnson',
    date: 'January 25, 2026',
    category: 'Digital Marketing',
    image:
      'https://images.unsplash.com/photo-1657812160299-6b656decd5b1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzZW8lMjBzZWFyY2glMjBlbmdpbmUlMjBvcHRpbWl6YXRpb258ZW58MXx8fHwxNzcwNzAyNTQ4fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    featured: false,
  },
]
const categories = [
      ...
      <section className="relative py-24 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              {' '}
              <TrendingUp size={18} /> <span>Knowledge Hub</span>
            </motion.span>{' '}
            <h1 className="text-5xl md:text-7xl font-bold mb-6">Insights & Articles</h1>{' '}
            <p className="text-xl text-gray-300 leading-relaxed">
              Stay updated with the latest trends, insights, and best practices in technology and
                ...
                <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all border border-gray-100">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between text-sm text-gray-500 mb-4">
                      ...
                      <div className="flex items-center space-x-2">
                        {' '}
                        <Calendar size={14} /> <span className="text-xs">{post.date}</span>
                      </div>
                    </div>{' '}
