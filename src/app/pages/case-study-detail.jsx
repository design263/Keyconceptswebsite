...
const caseStudies = [
  {
    ...
    solution:
      "We implemented a comprehensive Odoo ERP solution tailored to TechCorp's specific manufacturing needs. The solution integrated all business processes including inventory management, production planning, sales, purchasing, and financial management into a single unified system. We also developed custom modules for their unique quality control processes and automated reporting systems.",
    result:
      'The implementation resulted in a 45% increase in operational efficiency, 30% reduction in operational costs, and improved on-time delivery rates from 72% to 96%. The company achieved full ROI within 6 months of implementation.',
    image:
    ...
    testimonial: {
      quote:
        'Key Concepts transformed our operations completely. Their custom ERP solution has given us the visibility and control we needed to scale our business efficiently.',
  ...
  },
  {
    ...
    industry: 'Retail',
    challenge:
      'RetailMax Group, a traditional brick-and-mortar retailer, needed to establish a strong online presence to compete with e-commerce giants. They lacked the infrastructure and technical expertise to build a scalable platform.',
    solution:
      'We developed a comprehensive e-commerce platform with integrated inventory management, seamless checkout experience, and mobile-first design. The solution included real-time inventory synchronization across all channels and personalized shopping experiences.',
    result:
      'RetailMax experienced 120% growth in sales, tripled their customer reach, and reduced order processing time by 60%. The platform now handles over 10,000 daily transactions.',
    image:
    ...
    testimonial: {
      quote:
        "The e-commerce platform exceeded our expectations. We're now competing effectively in the digital marketplace while maintaining our customer service standards.",
      author: 'Maria Santos',
  ...
  },
  {
    ...
    industry: 'SaaS',
    challenge:
      'InnovateTech, an early-stage startup, needed to validate their product-market fit quickly with limited resources. They had a great idea but needed to build and launch fast to secure funding.',
    solution:
      'Our MVP Studio team worked closely with InnovateTech to develop a feature-rich minimum viable product in just 12 weeks. We used agile methodologies, rapid prototyping, and modern tech stack to deliver a scalable solution.',
    result:
      'The MVP successfully secured $2M in seed funding and acquired their first 1,000 users within 3 months of launch. The product is now processing over $1M in monthly transactions.',
    image:
    ...
    testimonial: {
      quote:
        "Key Concepts' MVP Studio was instrumental in our success. They helped us move from concept to funded startup in record time.",
      author: 'Alex Kumar',
  ...
  },
  {
    ...
    challenge:
      'GlobalServices Inc was running on legacy on-premise infrastructure that was causing frequent downtime and limiting their ability to scale. They needed a modern cloud solution without disrupting their 24/7 operations.',
    solution:
      'We executed a phased cloud migration strategy using AWS, ensuring zero downtime during the transition. We re-architected their applications for cloud-native deployment and implemented automated backup and disaster recovery systems.',
    result:
      'The migration achieved 99.9% uptime, 3x performance improvement, and 40% reduction in infrastructure costs. The company can now scale resources on-demand and has improved disaster recovery capabilities.',
    image:
    ...
    testimonial: {
      quote:
        'The cloud migration was flawless. Key Concepts delivered on their promise of zero downtime while dramatically improving our infrastructure performance.',
      author: 'Robert Chen',
      ...
      <section className="relative pt-32 pb-12 overflow-hidden bg-gradient-to-br from-gray-50 to-white">
        ...
        <div className="relative w-full max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              {' '}
              <ArrowLeft size={20} /> <span>Back to Case Studies</span>
            </Link>
          </motion.div>{' '}
          <motion.div
            initial={{
          ...
          >
            {caseStudy.metrics.map((metric, idx) => (
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100" key={idx}>
                {' '}
