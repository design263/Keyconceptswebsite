...
function ServicesSection() {
  return /* @__PURE__ */ jsx("section", { className: "py-24 bg-gradient-to-b from-white to-gray-50", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
            ...
            /* @__PURE__ */ jsx("h2", { className: "text-4xl md:text-5xl font-bold mb-4", children: "Core Capabilities" }),
            /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-600 max-w-2xl mx-auto", children: "Empowering businesses with innovative solutions across product development, rapid MVP creation, and enterprise ERP systems" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: trendingServices.map((service, index) => /* @__PURE__ */ jsx(
            motion.div,
            {
              initial: { opacity: 0, y: 50 },
              whileInView: { opacity: 1, y: 0 },
              ...
              children: /* @__PURE__ */ jsxs("div", { className: "relative bg-white/60 backdrop-blur-lg rounded-2xl p-8 shadow-lg border border-white/60 hover:bg-white hover:border-[#f1592a] hover:shadow-2xl transition-all duration-300", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-6", children: [
                  /* @__PURE__ */ jsxs("div", { className: "relative w-14 h-14 flex-shrink-0 group-hover:scale-110 transition-transform", children: [
                    /* @__PURE__ */ jsx("div", { className: "w-full h-full bg-gray-100 rounded-xl flex items-center justify-center", children: /* @__PURE__ */ jsx(service.icon, { className: "text-gray-700", size: 28, strokeWidth: 1.5 }) }),
                    /* @__PURE__ */ jsx("div", { className: "absolute -bottom-1 -right-1 w-4 h-4 bg-[#f1592a] rounded-full border-2 border-white" })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold mb-2", children: service.title }),
                    /* @__PURE__ */ jsx("p", { className: "text-gray-600 leading-relaxed", children: service.description })
                  ] })
                ] }),
                /* @__PURE__ */ jsx("div", { className: `absolute inset-0 bg-gradient-to-br ${service.gradient} opacity-0 group-hover:opacity-5 transition-opacity rounded-2xl shadow-lg` })
              ] })
            },
            service.title
          )) })
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
            ...
            /* @__PURE__ */ jsx("h2", { className: "text-4xl md:text-5xl font-bold mb-4", children: "Comprehensive IT Solutions" }),
            /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-600 max-w-2xl mx-auto", children: "From strategy to execution, we deliver excellence in every aspect of digital transformation" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[280px]", children: services.map((service, index) => /* @__PURE__ */ jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "absolute inset-0", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: `absolute inset-0 bg-gradient-to-br ${service.color} opacity-80 group-hover:opacity-90 transition-opacity` })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "relative h-full p-8 flex flex-col justify-end text-white", children: [
                  /* @__PURE__ */ jsx("div", { className: "mb-4 transform group-hover:scale-110 transition-transform origin-left", children: /* @__PURE__ */ jsx("div", { className: "w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center", children: /* @__PURE__ */ jsx(service.icon, { size: 24 }) }) }),
                  /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold mb-2", children: service.title }),
                  /* @__PURE__ */ jsx("p", { className: "text-white/90 text-sm leading-relaxed", children: service.description }),
                  /* @__PURE__ */ jsx("div", { className: "absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity", children: /* @__PURE__ */ jsx("div", { className: `absolute inset-0 ${service.color} blur-xl`, style: { transform: "translateY(50%)" } }) })
                ] }),
                /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[#f1592a]/10 opacity-0 group-hover:opacity-100 transition-opacity" })
              ]
            },
            service.title
          )) })
