...
function OdooERPPage() {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white", children: [
            ...
            /* @__PURE__ */ jsxs(
              motion.span,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-gray-700", children: "Official Odoo Partner" })
                ]
              }
            ),
            /* @__PURE__ */ jsxs(
              motion.h1,
              {
                ...
                children: [
                  ...
                  " ",
                  /* @__PURE__ */ jsx("span", { className: "bg-gradient-to-r from-[#f1592a] to-[#ff7a45] bg-clip-text text-transparent", children: "Modern Businesses" })
                ]
              }
            ),
            /* @__PURE__ */ jsx(
              motion.p,
              {
                ...
                children: "Transform your business operations with intelligent, integrated Odoo ERP solutions. From implementation to customization, we deliver excellence at every step."
              }
            ),
            /* @__PURE__ */ jsxs(
              motion.div,
                ...
                children: [
                  /* @__PURE__ */ jsxs(
                    motion.a,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsx("span", { className: "font-semibold", children: "Request Odoo Consultation" }),
                  ...
                  /* @__PURE__ */ jsx(
                    motion.a,
                    {
                      ...
                      children: /* @__PURE__ */ jsx("span", { className: "font-semibold", children: "Explore Services" })
                    }
                  )
                ]
              }
    ...
    /* @__PURE__ */ jsx("section", { id: "services", className: "py-24 bg-gradient-to-b from-white to-gray-50", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 30 },
          ...
          children: [
            /* @__PURE__ */ jsx(
              motion.span,
              {
                ...
                children: "Our Odoo Services"
              }
            ),
            /* @__PURE__ */ jsx("h2", { className: "text-4xl md:text-5xl font-bold mb-4", children: "Comprehensive Odoo Development Services" }),
            /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-600 max-w-3xl mx-auto", children: "End-to-end Odoo solutions designed to streamline operations, boost productivity, and drive business growth" })
          ]
        }
      ),
      /* @__PURE__ */ jsx("div", { className: "space-y-24", children: services.map((service, index) => /* @__PURE__ */ jsx(
        motion.div,
        {
          ...
          className: "group",
          children: /* @__PURE__ */ jsxs("div", { className: `grid grid-cols-1 lg:grid-cols-2 gap-[120px] items-center ${service.imagePosition === "right" ? "lg:grid-flow-dense" : ""}`, children: [
            /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxs("div", { className: "relative rounded-3xl overflow-hidden shadow-2xl group-hover:shadow-[#f1592a]/20 transition-all duration-300", children: [
                    /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-[#f1592a]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10" }),
                    /* @__PURE__ */ jsx(
                      ImageWithFallback,
                      {
                        src: service.image,
                  ...
                  /* @__PURE__ */ jsx("div", { className: "absolute -bottom-4 -right-4 w-24 h-24 bg-[#f1592a]/10 rounded-full blur-2xl" })
                ]
              }
            ),
            /* @__PURE__ */ jsxs("div", { className: service.imagePosition === "right" ? "lg:col-start-1 lg:row-start-1" : "", children: [
              /* @__PURE__ */ jsxs("div", { className: "relative w-16 h-16 mb-6 group-hover:scale-110 transition-transform", children: [
                /* @__PURE__ */ jsx("div", { className: "w-full h-full bg-gray-100 rounded-2xl flex items-center justify-center group-hover:bg-white transition-all shadow-lg", children: /* @__PURE__ */ jsx(service.icon, { className: "text-gray-700", size: 32, strokeWidth: 1.5 }) }),
              ...
              /* @__PURE__ */ jsx("p", { className: "text-gray-600 mb-8 leading-relaxed text-lg", children: service.description }),
              /* @__PURE__ */ jsx("ul", { className: "space-y-4", children: service.features.map((feature, idx) => /* @__PURE__ */ jsxs(
                motion.li,
                {
        ...
        /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("h2", { className: "text-4xl md:text-5xl font-bold mb-4", children: "Industries We Serve" }),
              /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-600 max-w-3xl mx-auto", children: "Proven Odoo ERP implementations across diverse industries, delivering tailored solutions for unique business challenges" })
            ]
          }
        ),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6", children: industries.map((industry, index) => /* @__PURE__ */ jsx(
          motion.div,
          {
            initial: { opacity: 0, y: 50 },
            whileInView: { opacity: 1, y: 0 },
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "relative bg-white/60 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-white/60 hover:bg-white hover:border-[#f1592a] hover:shadow-2xl transition-all duration-300 h-full text-center", children: [
              /* @__PURE__ */ jsxs("div", { className: "relative w-14 h-14 mb-4 mx-auto group-hover:scale-110 transition-transform", children: [
                /* @__PURE__ */ jsx("div", { className: "w-full h-full bg-gray-100 rounded-xl flex items-center justify-center group-hover:bg-white transition-all", children: /* @__PURE__ */ jsx(industry.icon, { className: "text-gray-700", size: 28, strokeWidth: 1.5 }) }),
                /* @__PURE__ */ jsx("div", { className: "absolute -bottom-1 -right-1 w-3 h-3 bg-[#f1592a] rounded-full border-2 border-white" })
              ] }),
              /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold mb-2", children: industry.name }),
              /* @__PURE__ */ jsx("p", { className: "text-gray-600 text-sm leading-relaxed", children: industry.description })
            ] })
          },
          industry.name
        )) })
    ...
    /* @__PURE__ */ jsx("section", { className: "py-24 bg-gradient-to-b from-gray-50 to-white", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("h2", { className: "text-4xl md:text-5xl font-bold mb-6", children: [
              ...
              " ",
              /* @__PURE__ */ jsx("span", { className: "bg-gradient-to-r from-[#f1592a] to-[#ff7a45] bg-clip-text text-transparent", children: "Odoo ERP?" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-600 leading-relaxed", children: "As an official Odoo partner with 16+ years of experience, we bring deep expertise, proven methodologies, and a commitment to your success." })
          ]
        }
      ),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: [
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsx("div", { className: "relative w-12 h-12 mx-auto mb-4", children: /* @__PURE__ */ jsx("div", { className: "w-full h-full bg-gradient-to-br from-[#f1592a] to-[#ff7a45] rounded-xl flex items-center justify-center", children: /* @__PURE__ */ jsx(CheckCircle, { className: "text-white", size: 24, strokeWidth: 2 }) }) }),
      ...
      /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("h2", { className: "text-4xl md:text-5xl font-bold mb-6", children: "Transform Your Business with Odoo ERP" }),
            /* @__PURE__ */ jsx("p", { className: "text-xl text-white/90 mb-10 leading-relaxed", children: "Schedule a free consultation with our Odoo experts and discover how we can streamline your operations and accelerate growth." }),
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4", children: [
              /* @__PURE__ */ jsxs(
                motion.a,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("span", { children: "Request Odoo Consultation" }),
                    /* @__PURE__ */ jsx(ArrowRight, { className: "group-hover:translate-x-1 transition-transform", size: 20 })
                  ]
                }
              ),
