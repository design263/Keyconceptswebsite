        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-br from-[#f1592a] to-[#ff7a45] p-5 md:p-6 rounded-t-2xl", children: /* @__PURE__ */ jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsx("h2", { className: "text-xl md:text-2xl font-bold text-white mb-1.5", children: "Let's Get Started" }),
                /* @__PURE__ */ jsx("p", { className: "text-white/90 text-xs md:text-sm", children: "Fill out the form below and our team will get back to you within 24 hours" })
              ]
            }
          ) }),
          /* @__PURE__ */ jsx("div", { className: "p-5 md:p-6", children: submitSuccess ? /* @__PURE__ */ jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-gray-900 mb-2", children: "Thank You!" }),
                /* @__PURE__ */ jsx("p", { className: "text-gray-600 text-sm", children: "We've received your enquiry and will be in touch soon." })
              ]
            }
