...
function OurStoryPage() {
  return (
    <>
      <SEO
        title="Our Story"
        description="Discover the journey of Key Concepts, a new generation company with a legacy of delivering high-quality software engineering and ERP solutions."
      />
