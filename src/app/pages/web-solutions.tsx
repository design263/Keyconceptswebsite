...
import { Globe, Zap, Shield, Cloud, Database, Code2, Layers, Gauge, Rocket, Lock, Server, Terminal, CheckCircle, ArrowRight, TrendingUp, Eye, Smartphone, ShoppingCart, Layout, Puzzle, Network } from "lucide-react";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                >
                  ...
                  <span className="text-sm font-semibold tracking-wider text-[#f1592a]">WEB DEVELOPMENT</span>
                </motion.div>
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="bg-gradient-to-br from-gray-100 to-gray-50 rounded-2xl border-2 border-gray-200 shadow-2xl overflow-hidden">
                    ...
                    {/* Wireframe Content */}
                    <div className="p-8 relative" style={{ minHeight: '400px' }}>
                      {/* Grid Pattern */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <div className="inline-flex items-center space-x-2 px-4 py-2 bg-[#f1592a]/5 backdrop-blur-sm rounded-full border border-[#f1592a]/10 mb-8">
                  ...
                  <span className="text-sm font-semibold text-[#f1592a]">OPTIMIZED PERFORMANCE</span>
                </div>
                ...
                <p className="text-xl text-gray-600 mb-8 leading-relaxed font-light">
                  Every millisecond counts. Our web solutions are engineered for speed, 
                  delivering perfect 100/100 Lighthouse scores across all metrics.
                </p>
                ...
                <div className="relative z-10">
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                    ...
                    <div className="lg:col-span-1">
                      ...
                      <p className="text-gray-600 font-light leading-relaxed mb-6">{solution.description}</p>
