...
function JobDetailPage() {
  ...
  if (!job) {
    return /* @__PURE__ */ jsx("div", { className: "min-h-screen flex items-center justify-center", children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold text-gray-900 mb-4", children: "Job Not Found" }),
      /* @__PURE__ */ jsx(Link, { to: "/careers", className: "text-[#f1592a] hover:underline", children: "Back to Careers" })
    ] }) });
  }
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white", children: [
    /* @__PURE__ */ jsx("section", { className: "pt-32 pb-12 bg-gradient-to-b from-gray-50 to-white", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsx(Link, { to: "/careers", children: /* @__PURE__ */ jsxs(
        motion.button,
        {
          whileHover: { x: -5 },
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "font-medium", children: "Back to Careers" })
          ]
        }
      ) }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsx("div", { className: "flex items-start space-x-4 mb-6", children: /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h1", { className: "text-3xl md:text-5xl font-bold text-gray-900 mb-2", children: job.title }),
            /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-3 text-gray-600", children: [
              /* @__PURE__ */ jsxs("span", { className: "flex items-center space-x-1", children: [
                /* @__PURE__ */ jsx(Briefcase, { size: 16, strokeWidth: 2 }),
                /* @__PURE__ */ jsx("span", { children: job.department })
              ] }),
              /* @__PURE__ */ jsx("span", { children: "\u2022" }),
              /* @__PURE__ */ jsxs("span", { className: "flex items-center space-x-1", children: [
                /* @__PURE__ */ jsx(MapPin, { size: 16, strokeWidth: 2 }),
                /* @__PURE__ */ jsx("span", { children: job.location })
              ] }),
              /* @__PURE__ */ jsx("span", { children: "\u2022" }),
              /* @__PURE__ */ jsxs("span", { className: "flex items-center space-x-1", children: [
                /* @__PURE__ */ jsx(Clock, { size: 16, strokeWidth: 2 }),
                /* @__PURE__ */ jsx("span", { children: job.type })
              ] })
            ] })
          ] }) }),
          /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-700 leading-relaxed mb-6", children: job.description }),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-2 px-4 py-2 bg-gray-100 rounded-xl", children: [
              /* @__PURE__ */ jsx(DollarSign, { className: "text-[#f1592a]", size: 18, strokeWidth: 2 }),
              /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-gray-700", children: job.salary })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-2 px-4 py-2 bg-gray-100 rounded-xl", children: [
              /* @__PURE__ */ jsx(Users, { className: "text-[#f1592a]", size: 18, strokeWidth: 2 }),
              /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-gray-700", children: job.experience })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "lg:sticky lg:top-32 space-y-4", children: [
          /* @__PURE__ */ jsxs(
            motion.button,
            {
              ...
              children: [
                /* @__PURE__ */ jsx(FileText, { size: 20, strokeWidth: 2 }),
                /* @__PURE__ */ jsx("span", { children: "Apply for this Position" })
              ]
            }
          ),
          /* @__PURE__ */ jsxs("div", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxs(
              motion.button,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx(Share2, { size: 18, strokeWidth: 2 }),
                  /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold", children: "Share" })
                ]
              }
            ),
            /* @__PURE__ */ jsxs(
              motion.button,
              {
                ...
                className: "flex-1 flex items-center justify-center space-x-2 px-4 py-3 bg-white border-2 border-gray-200 rounded-xl hover:border-[#f1592a] transition-all",
                children: [
                  /* @__PURE__ */ jsx(Bookmark, { size: 18, strokeWidth: 2 }),
    ...
    /* @__PURE__ */ jsx("section", { className: "py-12", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto border border-gray-200 rounded-3xl shadow-lg p-8 md:p-12 bg-white", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold text-gray-900 mb-4", children: "Required Skills" }),
        /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: job.skills.map((skill) => /* @__PURE__ */ jsx(
          "span",
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "mb-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold text-gray-900 mb-6", children: "Responsibilities" }),
        /* @__PURE__ */ jsx("div", { className: "space-y-3", children: job.responsibilities.map((item, index) => /* @__PURE__ */ jsxs("div", { className: "flex items-start space-x-3", children: [
          /* @__PURE__ */ jsx(CheckCircle, { className: "text-[#f1592a] flex-shrink-0 mt-1", size: 20, strokeWidth: 2 }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-700 leading-relaxed", children: item })
        ] }, index)) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "mb-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold text-gray-900 mb-6", children: "Requirements" }),
        /* @__PURE__ */ jsx("div", { className: "space-y-3", children: job.requirements.map((item, index) => /* @__PURE__ */ jsxs("div", { className: "flex items-start space-x-3", children: [
          /* @__PURE__ */ jsx(CheckCircle, { className: "text-[#f1592a] flex-shrink-0 mt-1", size: 20, strokeWidth: 2 }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-700 leading-relaxed", children: item })
        ] }, index)) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "mb-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold text-gray-900 mb-6", children: "Nice to Have" }),
        /* @__PURE__ */ jsx("div", { className: "space-y-3", children: job.niceToHave.map((item, index) => /* @__PURE__ */ jsxs("div", { className: "flex items-start space-x-3", children: [
          /* @__PURE__ */ jsx("div", { className: "w-2 h-2 bg-[#f1592a] rounded-full flex-shrink-0 mt-2" }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-600 leading-relaxed", children: item })
        ] }, index)) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "mb-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold text-gray-900 mb-6", children: "Benefits" }),
        /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 gap-4", children: job.benefits.map((benefit, index) => /* @__PURE__ */ jsxs("div", { className: "flex items-start space-x-3 p-4 bg-gray-50 rounded-xl border border-gray-200", children: [
          /* @__PURE__ */ jsx(CheckCircle, { className: "text-[#f1592a] flex-shrink-0 mt-0.5", size: 18, strokeWidth: 2 }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-700 text-sm leading-relaxed", children: benefit })
        ] }, index)) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-8 md:p-12 text-center", children: [
        /* @__PURE__ */ jsx("h3", { className: "text-2xl md:text-3xl font-bold text-white mb-4", children: "Ready to Apply?" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-300 mb-8 max-w-2xl mx-auto", children: "Join our team and help us build the future of digital transformation. We're excited to learn more about you!" }),
        /* @__PURE__ */ jsxs(
          motion.button,
          {
            whileHover: { scale: 1.05 },
    ...
    isModalOpen && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4", children: /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsx("div", { className: "sticky top-0 bg-white border-b border-gray-200 p-6 z-10", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx(motion.div, { whileHover: { rotate: 90 }, transition: { duration: 0.2 }, children: /* @__PURE__ */ jsx(FileText, { size: 24 }) })
              }
            )
          ] }) }),
          /* @__PURE__ */ jsx("div", { className: "p-6 md:p-8", children: /* @__PURE__ */ jsxs("form", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "block text-sm font-semibold text-gray-700 mb-2", children: "Full Name *" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "block text-sm font-semibold text-gray-700 mb-2", children: "Email Address *" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "email",
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "block text-sm font-semibold text-gray-700 mb-2", children: "Phone Number *" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "tel",
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "block text-sm font-semibold text-gray-700 mb-2", children: "LinkedIn Profile" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "url",
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "block text-sm font-semibold text-gray-700 mb-2", children: "Cover Letter *" }),
              /* @__PURE__ */ jsx(
                "textarea",
                {
                  required: true,
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "block text-sm font-semibold text-gray-700 mb-2", children: "Resume/CV *" }),
              /* @__PURE__ */ jsxs("div", { className: "border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-[#f1592a] transition-all", children: [
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "file",
                ...
                /* @__PURE__ */ jsxs(
                  "label",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx("div", { className: "w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center", children: /* @__PURE__ */ jsx(FileText, { className: "text-gray-600", size: 24 }) }),
                      /* @__PURE__ */ jsxs("div", { children: [
                        /* @__PURE__ */ jsx("span", { className: "text-[#f1592a] font-semibold hover:underline", children: "Click to upload" }),
                        /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: " or drag and drop" })
                      ] }),
                      /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500", children: "PDF, DOC, DOCX (max 5MB)" })
                    ]
                  }
                )
              ] })
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-start space-x-3", children: [
              ...
              /* @__PURE__ */ jsx("label", { htmlFor: "terms", className: "text-sm text-gray-600", children: "I agree to the processing of my personal data and consent to being contacted regarding this application. *" })
            ] }),
