  ...
  return (
    <LayoutWrapper>
      <div className="min-h-screen bg-white">
        ...
        <section className="lg:py-24 py-16 bg-gradient-to-b from-gray-50 to-white relative">
          <div
            className="absolute inset-0 opacity-[0.02]"
            style={{
              backgroundImage:
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              <div className="relative z-10 max-w-3xl mx-auto">
                ...
                >
                  <Smartphone className="text-white w-8 h-8 md:w-10 md:h-10"  strokeWidth={1.5} />
                </motion.div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  >
                    <span className="text-sm md:text-md">View Case Studies</span>
                  </motion.button>
                </div>
              </div>
            </motion.div>
